...
<body>
<!--  -->
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/admin/productServlet.action"
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="pname" value="${product.pname}" id="userAction_save_do_pname" class="bg"/>
            </td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                是否热门：
            </td>
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="marketPrice" value="${product.marketPrice}"
                       id="userAction_save_do_market_price" class="bg"/>
            </td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                商城价格：
            </td>
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="shopPrice" value="${product.shopPrice}" id="userAction_save_do_shop_price"
                       class="bg"/>
            </td>
        </tr>
        <tr>
                ...
                <select name="cid">
                    <c:forEach items="${categoryList}" var="category">
                        <option value="${category.cid }"
                                <c:if test="${category.cid == product.cid}">selected</c:if> >${category.cname}</option>
                    </c:forEach>
                </select>
            </td>
        </tr>
